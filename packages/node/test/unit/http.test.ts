...
describe('FetchHttpClient', () => {
  ...
  it('should throw SonioxHttpError on non-2xx response', async () => {
    ...
    ).rejects.toThrow(SonioxHttpError);
...
describe('buildUrl', () => {
  ...
  it('should append query parameters', () => {
    expect(buildUrl('https://api.example.com', '/users', { page: 1 }))
      .toBe('https://api.example.com/users?page=1');
  });

  it('should skip undefined query values', () => {
    expect(buildUrl('https://api.example.com', '/users', { page: 1, filter: undefined }))
      .toBe('https://api.example.com/users?page=1');
  });
  ...
  it('should preserve absolute URLs in path', () => {
    expect(buildUrl('https://api.example.com', 'https://other.com/path'))
